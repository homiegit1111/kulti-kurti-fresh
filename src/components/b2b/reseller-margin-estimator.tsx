  ...
  return (
    <div className="border border-charcoal/10 bg-white p-5">
      <div className="mb-4 flex items-start gap-3">
        <div className="flex h-10 w-10 items-center justify-center border border-gold/35 text-gold-dark">
      ...
      <p className="mt-4 text-[10px] uppercase tracking-[0.14em] leading-relaxed text-charcoal/40">
...
function Metric({ label, value }: { label: string; value: string }) {
  return (
    <div className="border border-charcoal/10 px-2 py-3">
      <p className="font-serif text-lg text-charcoal">{value}</p>
      <p className="mt-1 text-[8px] font-bold uppercase tracking-[0.16em] text-charcoal/40">
        {label}
      </p>
    </div>
  );
